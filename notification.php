...
<table class="table table2 table-responsive table-hover">
				 <?php do { ?>
              <tr>
                <td style="min-width:100px"><h5 class="blue_font"><?php echo $row_notifications['heading']; ?></h5></td>
                <td style="min-width:100px"><h5><?php echo $row_notifications['time_stamp']; ?></h5></td>
                <td><p>
