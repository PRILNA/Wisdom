...
$query_event = "SELECT * FROM event ORDER BY time_stamp DESC";
$query_limit_event = sprintf("%s LIMIT %d, %d", $query_event, $startRow_event, $maxRows_event);
$event = mysql_query($query_limit_event, $wisdom) or die(mysql_error());
...
<div class="container-fluid bg_blue">
    ...
    <div class="row">
     ...
     <ol class="breadcrumb text-center orange_font" >
      ...
      <h1 class="blue_font text-center">Events</h1>
       ...
       <div class="col-md-12 pad10">
			...
			<table class="table table2 table-responsive table-hover">
			  <?php do { ?>
              <tr>
                <td style="min-width:100px" nowrap><h5 class="blue_font"><?php echo $row_event['heading']; ?></h5></td>
                <td style="min-width:100px" nowrap><h5><?php echo $row_event['time_stamp']; ?></h5></td>
                <td><p>
                   <?php echo $row_event['text']; ?>
                    </p>
               </td>
              </tr>
