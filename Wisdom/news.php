...
$query_news = "SELECT * FROM news ORDER BY time_stamp DESC";
$query_limit_news = sprintf("%s LIMIT %d, %d", $query_news, $startRow_news, $maxRows_news);
$news = mysql_query($query_limit_news, $wisdom) or die(mysql_error());
...
<div class="container-fluid bg_blue">
    ...
    <div class="row">
     ...
     <ol class="breadcrumb text-center orange_font" >
      ...
      <h1 class="blue_font text-center">News</h1>
       ...
       <div class="col-md-12 pad10">
			...
			<table class="table table2 table-responsive table-hover">
			  <?php do { ?>
              <tr>
                <td style="min-width:100px" nowrap><h5 class="blue_font"><?php echo $row_news['heading']; ?></h5></td>
                <td style="min-width:100px" nowrap><h5><?php echo $row_news['time_stamp']; ?></h5></td>
                <td><p>
