...
<body>
    ...
    <div class="row">
     ...
     <ol class="breadcrumb text-center orange_font" >
      ...
      <h1 class="blue_font text-center">Blog posts</h1>
        ...
        <?php do { ?>
       <div class="col-md-12 pad1030both">
       		...
       		<div class="box2">
                ...
                <p class="blog_small">
                <img src="images/<?php echo $row_blog_01['image_name']; ?>.jpg" class="img-responsive pull-left">
                <?php echo nl2br($row_blog_01['blog_text']); ?> 
                </p>
                <div class="row pad20"><div class="col-xs-12">
    ...
    <?php if(isset($_SESSION['MM_Username'])){ ?>
	<div class="bg_pattern" style="padding-bottom:40px">	
 ...
 <div class="container-fluid bg_footer2">
           <div class="col-md-12">
        	<div class="col-md-6">
