...
$maxRows_blog_search = 10;
$pageNum_blog_search = 0;
if (isset($_GET['pageNum_blog_search'])) {
  $pageNum_blog_search = $_GET['pageNum_blog_search'];
}
$startRow_blog_search = $pageNum_blog_search * $maxRows_blog_search;
...
$query_limit_blog_search = sprintf("%s LIMIT %d, %d", $query_blog_search, $startRow_blog_search, $maxRows_blog_search);
$blog_search = mysql_query($query_limit_blog_search, $wisdom) or die(mysql_error());
$row_blog_search = mysql_fetch_assoc($blog_search);

if (isset($_GET['totalRows_blog_search'])) {
  $totalRows_blog_search = $_GET['totalRows_blog_search'];
} else {
  $all_blog_search = mysql_query($query_blog_search);
  $totalRows_blog_search = mysql_num_rows($all_blog_search);
}
$totalPages_blog_search = ceil($totalRows_blog_search/$maxRows_blog_search)-1;
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="container-fluid bg_blue">
        ...
        <div class="col-md-5 text-center pad40">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="carousel-content">
                                    <div>
                                    	<h2 class="white_font">Knowledge is Powerful!</h2>
                                        <p class="white_font">
                                        We always try to discover something new, have deeper knowledge of various subjects and simply learn the world better. Curiosity is always a beautiful thing, and what if it gives you better job, better career and better life! Yes, begin your quest with us!
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="carousel-content">
                                    <div>
                                    	<h2 class="white_font">Imagination is Endless!</h2>
                                        <p class="white_font">
                                        Imagination is stronger than knowledge and is more powerful. That myth is more potent than history. That dreams are more powerful than facts. That hope always triumphs over experience. That laughter is the only cure for grief. And I believe that love is stronger than death.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="carousel-content">
                                    <div>    
                                    	<h2 class="white_font">Science is Immortal!</h2>
                                        <p class="white_font">
            ...
            <a href="courses.php" class="more-btn2">Our Courses</a>
        </div></div><div class="clearfix"></div><br><br>
    </div><!--containerfluid -->
          ...
          <div class="box1">
            <h2 class="orange_font box-header">Notifications</h2>
               ...
               <p><?php echo $row_wisdom_notification['text']; ?></p>
                ...
                <div class="row pad2540both"> 
                    <div class="col-md-12">     
                        <a href="notification.php" class="more-btn2 white_font">More..</a>
                    </div><!--col-md-12 -->
                </div> <!--row --> 
        	</div><!--box1 -->
        </div><!--col-md-4 -->
			...
			<h2 class="orange_font box-header">Upcoming Event</h2>
              ...
              <h4 class="blue_font"><?php echo $row_wisdom_event['heading']; ?></h4>
               <p><?php echo $row_wisdom_event['text']; ?></p>
                ...
                <div class="row pad2540both"> 
                    <div class="col-md-12">     
                        <a href="event.php" class="more-btn2 white_font">More..</a>
                    </div><!--col-md-12 -->
                </div> <!--row --> 
       </div><!--box1 -->  
     </div><!--col-md-4 -->
          ...
          <div class="box1">
			<h2 class="orange_font box-header">Campus News</h2>
             ...
             <?php } while ($row_wisdom_news = mysql_fetch_assoc($wisdom_news)); ?>
                <div class="row pad2540both"> 
                    <div class="col-md-12">     
                        <a href="news.php" class="more-btn2 white_font">More..</a>
                    </div><!--col-md-12 -->
                </div> <!--row --> 
          </div><!--box1 -->
     </div><!--col-md-4 -->
